...
from aivinnet.models import FavType
from aivinnet.serializers.album import serialize_for_card, serialize_for_card_many
from aivinnet.serializers.artist import (
