...
from aivinnet.api.apischemas import AlbumHashSchema, AlbumLimitSchema, ArtistHashSchema
from aivinnet.config import UserConfig
from aivinnet.db.userdata import FavoritesTable, SimilarArtistTable
from aivinnet.db.utils import favorites_to_dataclass
